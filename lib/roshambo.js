(function() {
  ...
  $(function() {
    ...
    Roshambo = (function() {
      ...
      Roshambo.prototype.autosave = function() {
        var html;
        html = this.el.html();
        return localStorage.setItem(this.config.autosave_key, html);
      };

      Roshambo.prototype.enableStyles = function(sel) {
        var handle_tag, parentTag, tag,
          _this = this;
        ...
        if (parentTag === 'B' || parentTag === 'I') handle_tag(parentTag);
      ...
      Roshambo.prototype.handleKeypress = function(event) {
        ...
        if (this.config.should_autosave) return this.autosave();
      };
      ...
      Roshambo.prototype.handleShortcuts = function(event) {
        ...
        if (event.metaKey && event.which === 73) {
          if (this.isItalic) {
            return this.disableItalic();
          } else {
