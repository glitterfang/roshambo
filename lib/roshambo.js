(function() {
  ...
  $(function() {
    ...
    Roshambo = (function() {
      ...
      Roshambo.prototype.synchronize = function() {
        if (!this.isBold && this.config.boldButton.hasClass('active')) {
          return this.config.boldButton.removeClass('active');
        } else if (this.isBold && !this.config.boldButton.hasClass('active')) {
          return this.config.boldButton.addClass('active');
        }
      };
